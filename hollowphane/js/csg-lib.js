...
class Node {
    ...
    build(polygons) {
        ...
        let front = []
            , back = [];
        //////////////
        // let counter = this.gdCounter + 0;
        // console.log(counter, "sending:", front, back);
        // // let returnedData = await this.gdTest(polygons, counter);
        // // console.log(counter, "receiving:", returnedData.front, returnedData.back);
        // // front = returnedData.front;
        // // back = returnedData.back;
        ...
        // this.gdTest(polygons, counter).then(returnedData => {
        //     console.log(counter, "receiving:", returnedData.front, returnedData.back);
        //     front = returnedData.front;
        //     back = returnedData.back;
        //     if (front.length) {
        //         console.log("f in", this.front);
        //         if (!this.front)
        //             this.front = new Node();
        //         this.front.build(front);
        //     }
        //     if (back.length) {
        //         console.log("b in", this.back);
        //         if (!this.back)
        //             this.back = new Node();
        //         this.back.build(back);
        //     }
        ...
        // console.log("regular:", front, back);
        if (front.length) {
            if (!this.front)
                this.front = new Node();
            this.front.build(front);
    ...
    async gdTest(polygons, counter) {
        console.log(counter, "incoming out:", polygons, this.polygons);
        return new Promise((resolve, reject) => {
            try {
                ...
                let front = [];
                let back = [];
                console.log(counter, "incoming in:", polygons, this.polygons);
                for (let i = 0; i < polygons.length; i++) {
                    this.plane.splitPolygon(polygons[i], this.polygons, this.polygons, front, back);
                }
                // console.log(counter, "outgoing:", front, back);
                resolve({ front: front, back: back });
            }
            catch (e) {
                console.log(counter, 'gd err', e);
                reject(e);
            }
        });
    }
